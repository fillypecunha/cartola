...
arrayDisp[23].src = "./images/kvaratskhelia.jpg";
arrayDisp[24].src = "./images/leao.webp"; 
arrayDisp[24].src = "./images/courtois.jpg"; 
...
function image(array) {
 ...
 for(let i =0;i < array.length;i++) {
  spans.forEach((currentSpan)=>{
     currentSpan.innerHTML+= `<img src="${array[i].src} ">`
})}
}
